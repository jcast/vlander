...
- (struct _NSSize)_fetchRenderingSize;
- (void)_updateRenderingSize;
- (void)_displayGoneOffline:(struct _CGDirectDisplayID *)fp8;
- (void)_displayGoneOnline:(struct _CGDirectDisplayID *)fp8;
- (void)_configurationChangedForData:(id)fp8;
- (void)_resetFadeInTimer;
- (void)_fadeOutDisplay;
